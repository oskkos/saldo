...
- [ ] 1.2 Create the docs tree scaffold: `mkdocs.yml`, the user-guide directory, a screenshots directory, and a placeholder nav
- [ ] 1.3 Decide and document the docs-tree layout and manifest location (resolves Open Question), and add a short README for building the site locally

## 2. Manifest and helper scripts

- [ ] 2.1 Define the content-hash manifest format (per-page → cited capability + requirement + hash) and implement a hashing helper over `openspec/specs/**`
